...
// means of death data
// must be in sync with enum meansOfDeath_t in bg_public.h
const meansOfDeathData_t bg_meansOfDeathData[] =
{
	{ "MOD_UNKNOWN" },
	{ "MOD_SHOTGUN" },
	{ "MOD_BLASTER" },
...
const size_t bg_numMeansOfDeath = ARRAY_LEN( bg_meansOfDeathData );
